...
function initialize(i, realm) {
  ...
  i.SymbolIsConcatSpreadable = new _index.SymbolValue(realm, "Symbol.isConcatSpreadable", "Symbol.isConcatSpreadable");
  i.SymbolSpecies = new _index.SymbolValue(realm, "Symbol.species", "Symbol.species");
  i.SymbolReplace = new _index.SymbolValue(realm, "Symbol.replace", "Symbol.replace");
  i.SymbolIterator = new _index.SymbolValue(realm, "Symbol.iterator", "Symbol.iterator");
  i.SymbolHasInstance = new _index.SymbolValue(realm, "Symbol.hasInstance", "Symbol.hasInstance");
  i.SymbolToPrimitive = new _index.SymbolValue(realm, "Symbol.toPrimitive", "Symbol.toPrimitive");
  i.SymbolToStringTag = new _index.SymbolValue(realm, "Symbol.toStringTag", "Symbol.toStringTag");
  i.SymbolMatch = new _index.SymbolValue(realm, "Symbol.match", "Symbol.match");
  i.SymbolSplit = new _index.SymbolValue(realm, "Symbol.split", "Symbol.split");
  i.SymbolSearch = new _index.SymbolValue(realm, "Symbol.search", "Symbol.search");
  i.SymbolUnscopables = new _index.SymbolValue(realm, "Symbol.unscopables", "Symbol.unscopables");
  ...
  //
  var builtins = ["Object", "Function", "Symbol", "String", "Array", "Boolean", "RegExp", "Date", "Error", "Number", "TypeError", "RangeError", "ReferenceError", "SyntaxError", "URIError", "EvalError", "DataView", "Float32Array", "Float64Array", "Int8Array", "Int16Array", "Int32Array", "Map", "Set", "Promise", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "ArrayBuffer"];
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION)) {
