...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("apply", 2, function (func, _ref3) {
    ...
    if ((0, _has.HasSomeCompatibleType)(realm, argArray, _index.NullValue, _index.UndefinedValue)) {
  ...
  obj.defineNativeMethod("toString", 0, function (context) {
    ...
    if (context instanceof _index.NativeFunctionValue) {
      return new _index.StringValue(realm, "function " + context.name + "() { [native code] }");
      ...
      throw new _completions.ThrowCompletion(new _index.StringValue(realm, "Function.prototype.toString is not generic"));
    }
  });
};
