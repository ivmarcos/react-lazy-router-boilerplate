...
exports.default = function (realm) {
  ...
  obj.defineNativeMethod("stringify", 3, function (context, _ref3) {
    ...
    if (value instanceof _index.AbstractValue) {
      ...
      var result = realm.deriveAbstract(new _index3.TypesDomain(_index.StringValue), _index3.ValuesDomain.topVal, [value, clonedValue], function (_ref5) {
        var _ref6 = _slicedToArray(_ref5, 1),
            node = _ref6[0];

        return buildJSONStringify({
          OBJECT: node
        });
      }, "JSON.stringify(...)");
  ...
  // ECMA262 24.3.1
  obj.defineNativeMethod("parse", 2, function (context, _ref7) {
    ...
    if (text instanceof _index.AbstractValue && text.kind === "JSON.stringify(...)") {
      ...
      var value = text.args[0];
      var clonedValue = text.args[1];
      ...
      var buildNode = function buildNode(_ref9) {
        var _ref10 = _slicedToArray(_ref9, 1),
            node = _ref10[0];

        return buildJSONParse({
          STRING: node
        });
      };
      ...
      (0, _invariant2.default)((0, _index2.HasSomeCompatibleType)(realm, unfiltered, _index.PrimitiveValue, _index.ObjectValue, _index.ArrayValue), "expected primitive, object or array");
    }
...
var buildJSONStringify = (0, _builder2.default)("JSON.stringify(OBJECT)");
var buildJSONParse = (0, _builder2.default)("JSON.parse(STRING)");
...
function InternalGetTemplate(realm, val) {
  ...
  try {
    for (var _iterator2 = valTemplate.properties[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      ...
      if (value === undefined) throw _index.AbstractValue.createIntrospectionErrorThrowCompletion(val, key); // cannot handle accessors
...
function InternalJSONClone(realm, val) {
  if (val instanceof _index.AbstractValue) {
    if (val instanceof _index.AbstractObjectValue) {
      return realm.createAbstract(new _index3.TypesDomain(_index.ObjectValue), new _index3.ValuesDomain(new Set([InternalGetTemplate(realm, val)])), [val], function (_ref) {
