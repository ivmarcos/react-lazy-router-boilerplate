...
exports.default = function (realm) {
  ...
  function createRevoker() {
    var F = new _index.NativeFunctionValue(realm, undefined, undefined, 0, function (context, _ref5, argCount, NewTarget) {
      ...
      (0, _properties.ThrowIfInternalSlotNotWritable)(realm, F, "$RevocableProxy").$RevocableProxy = realm.intrinsics.null;

      // 4. Assert: p is a Proxy object.
      (0, _invariant2.default)(p instanceof _index.ProxyValue, "expected proxy");

      // 5. Set the [[ProxyTarget]] internal slot of p to null.
      (0, _properties.ThrowIfInternalSlotNotWritable)(realm, p, "$ProxyTarget").$ProxyTarget = realm.intrinsics.null;

      // 6. Set the [[ProxyHandler]] internal slot of p to null.
      (0, _properties.ThrowIfInternalSlotNotWritable)(realm, p, "$ProxyTarget").$ProxyHandler = realm.intrinsics.null;
