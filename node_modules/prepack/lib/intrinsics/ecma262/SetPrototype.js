...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("add", 1, function (context, _ref) {
    ...
    (0, _index2.ThrowIfInternalSlotNotWritable)(realm, S, "$SetData");
    entries.push(value);
  ...
  obj.defineNativeMethod("clear", 0, function (context) {
    ...
    (0, _index2.ThrowIfInternalSlotNotWritable)(realm, S, "$SetData").$SetData = [];
  ...
  obj.$DefineOwnProperty("size", {
    get: new _index.NativeFunctionValue(realm, "TODO", "get size", 0, function (context) {
      // 1. Let S be the this value.
      var S = context.throwIfNotConcrete();
  ...
  (0, _index2.ThrowIfMightHaveBeenDeleted)(valuesPropertyDescriptor.value);
