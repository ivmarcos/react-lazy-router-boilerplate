...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeGetter("byteLength", function (context) {
    ...
    // 5. Let buffer be O.[[ViewedArrayBuffer]].
    var buffer = O.$ViewedArrayBuffer;(0, _invariant2.default)(buffer);
    ...
    var size = O.$ByteLength;(0, _invariant2.default)(typeof size === "number");
  ...
  obj.defineNativeGetter("byteOffset", function (context) {
    ...
    var offset = O.$ByteOffset;(0, _invariant2.default)(typeof offset === "number");
  ...
  obj.defineNativeMethod("copyWithin", 2, function (context, _ref) {
    ...
    var len = O.$ArrayLength;(0, _invariant2.default)(typeof len === "number");
  ...
  obj.defineNativeMethod("join", 1, function (context, _ref19) {
    ...
    var R = void 0;
    if ((0, _has.HasSomeCompatibleType)(realm, element0, _index.UndefinedValue, _index.NullValue)) {
      R = "";
    } else {
    ...
    while (k < len) {
      ...
      var next = void 0;
      if ((0, _has.HasSomeCompatibleType)(realm, element, _index.UndefinedValue, _index.NullValue)) {
        next = "";
      } else {
  ...
  obj.defineNativeGetter("length", function (context) {
    ...
    var length = O.$ArrayLength;(0, _invariant2.default)(typeof length === "number");
  ...
  obj.defineNativeMethod("set", 1, function (context, _ref29) {
    ...
    if (!overloaded.$TypedArrayName) {
      ...
      var targetBuffer = target.$ViewedArrayBuffer;(0, _invariant2.default)(targetBuffer instanceof _index.ObjectValue);
      ...
      var targetLength = target.$ArrayLength;(0, _invariant2.default)(typeof targetLength === "number");

      // 11. Let targetName be the String value of target.[[TypedArrayName]].
      var targetName = target.$TypedArrayName;(0, _invariant2.default)(typeof targetName === "string");
      ...
      var targetByteOffset = target.$ByteOffset;(0, _invariant2.default)(typeof targetByteOffset === "number");
      ...
      // 8. Let targetBuffer be target.[[ViewedArrayBuffer]].
      var _targetBuffer = _target.$ViewedArrayBuffer;(0, _invariant2.default)(_targetBuffer instanceof _index.ObjectValue);
      ...
      // 10. Let targetLength be target.[[ArrayLength]].
      var _targetLength = _target.$ArrayLength;(0, _invariant2.default)(typeof _targetLength === "number");

      // 11. Let srcBuffer be typedArray.[[ViewedArrayBuffer]].
      var srcBuffer = typedArray.$ViewedArrayBuffer;(0, _invariant2.default)(srcBuffer);
      ...
      var _targetByteOffset = _target.$ByteOffset;(0, _invariant2.default)(typeof _targetByteOffset === "number");
      ...
      var _srcLength = typedArray.$ArrayLength;(0, _invariant2.default)(typeof _srcLength === "number");

      // 21. Let srcByteOffset be typedArray.[[ByteOffset]].
      var srcByteOffset = typedArray.$ByteOffset;(0, _invariant2.default)(typeof srcByteOffset === "number");
  ...
  obj.defineNativeMethod("slice", 2, function (context, _ref31) {
    ...
    var srcName = O.$TypedArrayName;(0, _invariant2.default)(typeof srcName === "string");
    ...
    var targetName = A.$TypedArrayName;(0, _invariant2.default)(typeof targetName === "string");
    ...
    if (srcType !== targetType) {
      ...
      var srcBuffer = O.$ViewedArrayBuffer;(0, _invariant2.default)(srcBuffer);
      ...
      var targetBuffer = A.$ViewedArrayBuffer;(0, _invariant2.default)(targetBuffer instanceof _index.ObjectValue);
      ...
      var srcByteOffset = O.$ByteOffset;(0, _invariant2.default)(typeof srcByteOffset === "number");

      // g. Let targetByteIndex be A.[[ByteOffset]].
      var targetByteIndex = A.$ByteOffset;(0, _invariant2.default)(typeof targetByteIndex === "number");
  ...
  obj.defineNativeMethod("subarray", 2, function (context, _ref37) {
    ...
    var srcLength = O.$ArrayLength;(0, _invariant2.default)(typeof srcLength === "number");
    ...
    var constructorName = O.$TypedArrayName;(0, _invariant2.default)(typeof constructorName === "string");
  ...
  obj.defineNativeMethod("toLocaleString", 0, function (context) {
    ...
    var len = array.$ArrayLength;(0, _invariant2.default)(typeof len === "number");
    ...
    var R = void 0;
    if ((0, _has.HasSomeCompatibleType)(realm, firstElement, _index.UndefinedValue, _index.NullValue)) {
    ...
    while (k < len) {
      ...
      if ((0, _has.HasSomeCompatibleType)(realm, nextElement, _index.UndefinedValue, _index.NullValue)) {
