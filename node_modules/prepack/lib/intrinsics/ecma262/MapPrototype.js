...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("clear", 0, function (context) {
    ...
    var entries = (0, _index2.ThrowIfInternalSlotNotWritable)(realm, M, "$MapData").$MapData;
    ...
    try {
      for (var _iterator2 = entries[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        if (p.$Key !== undefined && (0, _index2.SameValueZeroPartial)(realm, p.$Key, key)) {
          (0, _index2.ThrowIfInternalSlotNotWritable)(realm, M, "$MapData");
  ...
  (0, _index2.ThrowIfMightHaveBeenDeleted)(entriesPropertyDescriptor.value);
