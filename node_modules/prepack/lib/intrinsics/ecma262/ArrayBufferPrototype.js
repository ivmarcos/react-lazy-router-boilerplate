...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("slice", 2, function (context, _ref) {
    ...
    var fromBuf = O.$ArrayBufferData;(0, _invariant2.default)(fromBuf);

    // 20. Let toBuf be New.[[ArrayBufferData]].
    var toBuf = New.$ArrayBufferData;(0, _invariant2.default)(toBuf);
  ...
  // ECMA262 24.1.4.4
  obj.defineNativeProperty(realm.intrinsics.SymbolToStringTag, new _index.StringValue(realm, "ArrayBuffer"), { writable: false });
};
