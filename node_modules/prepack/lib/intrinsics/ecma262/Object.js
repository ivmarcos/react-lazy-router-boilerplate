...
exports.default = function (realm) {
  ...
  var func = new _index.NativeFunctionValue(realm, "Object", "Object", 1, function (context, _ref, argCount, NewTarget) {
    ...
    if ((0, _index2.HasSomeCompatibleType)(realm, value, _index.NullValue, _index.UndefinedValue)) {
  ...
  func.defineNativeMethod("assign", 2, function (context, _ref3) {
    ...
    try {
      for (var _iterator = sources[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        if ((0, _index2.HasSomeCompatibleType)(realm, nextSource, _index.NullValue, _index.UndefinedValue)) {
          continue;
        } else {
          // b. Else,
        ...
        if (to_must_be_partial) {
          ...
          if (to_keys.length !== 0) throw _index.AbstractValue.createIntrospectionErrorThrowCompletion(nextSource);
        }
  ...
  func.defineNativeMethod("create", 2, function (context, _ref5) {
    ...
    if (!(0, _index2.HasSomeCompatibleType)(realm, O, _index.ObjectValue, _index.NullValue)) {
  ...
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION)) func.defineNativeMethod("setPrototypeOf", 2, function (context, _ref41) {
    ...
    if (!(0, _index2.HasSomeCompatibleType)(realm, proto, _index.ObjectValue, _index.NullValue)) {
      throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
    }
