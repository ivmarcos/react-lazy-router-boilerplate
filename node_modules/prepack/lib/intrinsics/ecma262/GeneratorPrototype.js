...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("return", 1, function (context, _ref3) {
    ...
    var C = new _completions.ReturnCompletion(value);
  ...
  obj.defineNativeMethod("throw", 1, function (context, _ref5) {
    ...
    var C = new _completions.ReturnCompletion(exception);
  ...
  // ECMA262 25.3.1.5
  obj.defineNativeProperty(realm.intrinsics.SymbolToStringTag, new _index.StringValue(realm, "Generator"), { writable: false });
};
