...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("join", 1, function (context, _ref19) {
    ...
    var R = void 0;
    if ((0, _index2.HasSomeCompatibleType)(realm, element0, _index.UndefinedValue, _index.NullValue)) {
      R = "";
    } else {
    ...
    while (k < len) {
      ...
      var next = void 0;
      if ((0, _index2.HasSomeCompatibleType)(realm, element, _index.UndefinedValue, _index.NullValue)) {
        next = "";
      } else {
  ...
  obj.defineNativeMethod("toLocaleString", 0, function (context) {
    ...
    var R = void 0;
    if ((0, _index2.HasSomeCompatibleType)(realm, firstElement, _index.UndefinedValue, _index.NullValue)) {
    ...
    while (k < len) {
      ...
      if ((0, _index2.HasSomeCompatibleType)(realm, nextElement, _index.UndefinedValue, _index.NullValue)) {
