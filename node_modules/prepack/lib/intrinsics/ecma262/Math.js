...
exports.default = function (realm) {
  ...
  obj.defineNativeMethod("imul", 2, function (context, _ref) {
    ...
    if ((x instanceof _index.AbstractValue || y instanceof _index.AbstractValue) && (0, _index2.IsToNumberPure)(realm, x) && (0, _index2.IsToNumberPure)(realm, y)) {
      return realm.createAbstract(new _index3.TypesDomain(_index.NumberValue), _index3.ValuesDomain.topVal, [x, y], function (_ref3) {
        var _ref4 = _slicedToArray(_ref3, 2),
            a = _ref4[0],
            b = _ref4[1];

        return buildMathImul({ A: a, B: b });
      });
    }
  ...
  obj.defineNativeMethod("random", 0, function (context) {
    if (realm.mathRandomGenerator !== undefined) {
      ...
      return realm.deriveAbstract(new _index3.TypesDomain(_index.NumberValue), _index3.ValuesDomain.topVal, [], buildMathRandom);
    } else {
...
var buildMathRandom = (0, _builder2.default)("Math.random()");
var buildMathImul = (0, _builder2.default)("Math.imul(A, B)");
