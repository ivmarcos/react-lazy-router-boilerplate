...
exports.default = function (realm, obj) {
  ...
  obj.defineNativeMethod("match", 1, function (context, _ref17) {
    ...
    if (!(0, _has.HasSomeCompatibleType)(realm, regexp, _index.UndefinedValue, _index.NullValue)) {
  ...
  if (!realm.isCompatibleWith(realm.MOBILE_JSC_VERSION)) obj.defineNativeMethod("padEnd", 1, function (context, _ref21) {
    ...
    else filler = (0, _to.ToStringPartial)(realm, fillString);
  ...
  obj.defineNativeMethod("replace", 2, function (context, _ref27) {
    ...
    if (!(0, _has.HasSomeCompatibleType)(realm, searchValue, _index.NullValue, _index.UndefinedValue)) {
  ...
  obj.defineNativeMethod("split", 2, function (context, _ref33) {
    ...
    if (!(0, _has.HasSomeCompatibleType)(realm, separator, _index.UndefinedValue, _index.NullValue)) {
  ...
  function toCase(type, context, locales) {
    ...
    if (realm.isPartial && (type === "LocaleUpper" || type === "LocaleLower")) {
      ...
      throw _index.AbstractValue.createIntrospectionErrorThrowCompletion(O);
    }
