...
exports.default = function (realm) {
  ...
  function getCurrentTime() {
    if (realm.isPartial) {
      var dummyArg = new _index.StringValue(realm, "__Date.now()");
      return realm.deriveAbstract(new _index2.TypesDomain(_index.NumberValue), _index2.ValuesDomain.topVal, [dummyArg], buildDateNow);
    } else {
      var newNow = Date.now();
...
var buildDateNow = (0, _builder2.default)("Date.now()");
