...
function createResolveElementFunction(realm) {
  var resolveElement = new _index.NativeFunctionValue(realm, undefined, undefined, 1, function (context, _ref3) {
    ...
    var alreadyCalled = resolveElement.$AlreadyCalled;(0, _invariant2.default)(alreadyCalled);
    ...
    var myIndex = resolveElement.$Index;(0, _invariant2.default)(typeof myIndex === "number");

    // 5. Let values be the value of F's [[Values]] internal slot.
    var values = resolveElement.$Values;(0, _invariant2.default)(values instanceof Array);

    // 6. Let promiseCapability be the value of F's [[Capabilities]] internal slot.
    var promiseCapability = resolveElement.$Capabilities;(0, _invariant2.default)(promiseCapability);

    // 7. Let remainingElementsCount be the value of F's [[RemainingElements]] internal slot.
    var remainingElementsCount = resolveElement.$RemainingElements;(0, _invariant2.default)(remainingElementsCount);
...
function PerformPromiseThen(realm, promise, onFulfilled, onRejected, resultCapability) {
  ...
  if (promise.$PromiseState === "pending") {
    ...
    (0, _properties.ThrowIfInternalSlotNotWritable)(realm, promise, "$PromiseFulfillReactions");(0, _invariant2.default)(promise.$PromiseFulfillReactions);promise.$PromiseFulfillReactions.push(fulfillReaction);
    ...
    (0, _properties.ThrowIfInternalSlotNotWritable)(realm, promise, "$PromiseRejectReactions");(0, _invariant2.default)(promise.$PromiseRejectReactions);promise.$PromiseRejectReactions.push(rejectReaction);
...
function createResolveFunction(realm) {
  ...
  var resolve = new _index.NativeFunctionValue(realm, undefined, undefined, 1, function (context, _ref5) {
    ...
    var alreadyResolved = resolve.$AlreadyResolved;(0, _invariant2.default)(alreadyResolved !== undefined);
...
function createRejectFunction(realm) {
  ...
  var reject = new _index.NativeFunctionValue(realm, undefined, undefined, 1, function (context, _ref7) {
    ...
    // 3. Let alreadyResolved be the value of F's [[AlreadyResolved]] internal slot.
    var alreadyResolved = reject.$AlreadyResolved;(0, _invariant2.default)(alreadyResolved !== undefined);
...
function FulfillPromise(realm, promise, value) {
  ...
  var reactions = promise.$PromiseFulfillReactions;(0, _invariant2.default)(reactions);
