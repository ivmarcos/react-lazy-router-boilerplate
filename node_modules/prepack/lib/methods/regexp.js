...
function RegExpInitialize(realm, obj, pattern, flags) {
  ...
  var P = void 0;
  if (!pattern || (0, _has.HasCompatibleType)(realm, pattern, _index.UndefinedValue)) {
    P = "";
  } else {
  ...
  var F = void 0;
  if (!flags || (0, _has.HasCompatibleType)(realm, flags, _index.UndefinedValue)) {
    F = "";
  } else {
...
function RegExpExec(realm, R, S) {
  ...
  if ((0, _is.IsCallable)(realm, exec)) {
    ...
    if (!(0, _has.HasSomeCompatibleType)(realm, result, _index.ObjectValue, _index.NullValue)) {
