...
function GetViewValue(realm, view, requestIndex, isLittleEndian, type) {
  ...
  var buffer = view.$ViewedArrayBuffer;(0, _invariant2.default)(buffer);
  ...
  var viewOffset = view.$ByteOffset;(0, _invariant2.default)(typeof viewOffset === "number");

  // 9. Let viewSize be view.[[ByteLength]].
  var viewSize = view.$ByteLength;(0, _invariant2.default)(typeof viewSize === "number");
...
function GetValueFromBuffer(realm, arrayBuffer, byteIndex, type, isLittleEndian) {
  ...
  var block = arrayBuffer.$ArrayBufferData;(0, _invariant2.default)(block instanceof Uint8Array);
...
function CloneArrayBuffer(realm, srcBuffer, srcByteOffset, cloneConstructor) {
  ...
  var srcLength = srcBuffer.$ArrayBufferByteLength;(0, _invariant2.default)(typeof srcLength === "number");
  ...
  var srcBlock = srcBuffer.$ArrayBufferData;(0, _invariant2.default)(srcBlock);
  ...
  var targetBlock = targetBuffer.$ArrayBufferData;(0, _invariant2.default)(targetBlock);
