...
function OrdinaryGet(realm, O, P, Receiver, dataOnly) {
  ...
  if (dataOnly) {
    (0, _invariant2.default)(descValue instanceof _index2.AbstractValue);
    throw _index2.AbstractValue.createIntrospectionErrorThrowCompletion(descValue);
  }
...
function GetMethod(realm, V, P) {
  ...
  if ((0, _index3.HasSomeCompatibleType)(realm, func, _index2.NullValue, _index2.UndefinedValue)) {
