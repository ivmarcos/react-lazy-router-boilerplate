...
function IntegerIndexedObjectCreate(realm, prototype, internalSlotsList) {
  ...
  var A = new _index.IntegerIndexedExotic(realm);Object.assign(A, internalSlotsList);
...
function IntegerIndexedElementGet(realm, O, index) {
  ...
  var arrayTypeName = O.$TypedArrayName;(0, _invariant2.default)(typeof arrayTypeName === "string");
...
function AllocateTypedArrayBuffer(realm, O, length) {
  ...
  var constructorName = O.$TypedArrayName;(0, _invariant2.default)(constructorName);
...
function TypedArrayCreate(realm, constructor, argumentList) {
  ...
  if (argumentList.length === 1 && argumentList[0].mightBeNumber()) {
    if (argumentList[0].mightNotBeNumber()) {
      ...
      throw _index.AbstractValue.createIntrospectionErrorThrowCompletion(argumentList[0]);
    }
