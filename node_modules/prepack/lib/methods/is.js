...
function IsCallable(realm, func) {
  ...
  if ((0, _has.HasCompatibleType)(realm, func, _index.FunctionValue)) return true;
...
function IsPropertyKey(realm, arg) {
  ...
  if (arg instanceof _index.AbstractValue) throw _index.AbstractValue.createIntrospectionErrorThrowCompletion(arg);
