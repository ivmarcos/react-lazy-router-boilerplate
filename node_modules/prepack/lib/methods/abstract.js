...
// ECMA262 7.2.1
function RequireObjectCoercible(realm, arg) {
  if ((0, _has.HasSomeCompatibleType)(realm, arg, _index.NullValue, _index.UndefinedValue)) {
...
function Type(realm, val) {
  if (val instanceof _index.UndefinedValue) {
    ...
    return "Null";
  } else if ((0, _has.HasCompatibleType)(realm, val, _index.BooleanValue)) {
    return "Boolean";
  } else if ((0, _has.HasCompatibleType)(realm, val, _index.StringValue)) {
    return "String";
  } else if ((0, _has.HasCompatibleType)(realm, val, _index.SymbolValue)) {
    return "Symbol";
  } else if ((0, _has.HasCompatibleType)(realm, val, _index.NumberValue)) {
    return "Number";
