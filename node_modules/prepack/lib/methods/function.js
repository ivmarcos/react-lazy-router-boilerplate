...
function FunctionDeclarationInstantiation(realm, func, argumentsList) {
  ...
  try {
    for (var _iterator3 = formals[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      ...
      var paramBindings = t.getBindingIdentifiers(_param2, true);
  ...
  try {
    for (var _iterator5 = formals[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      var _param4 = _step5.value;

      if ((0, _index3.ContainsExpression)(realm, _param4)) {
  ...
  var varNames = [];
  (0, _traverse2.default)(code, function (node) {
  ...
  try {
    for (var _iterator6 = varDeclarations.reverse()[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      ...
      if (d.type !== "VariableDeclaration") {
        ...
        var fn = (0, _index3.BoundNames)(realm, d)[0];
  ...
  if (hasDuplicates === true) {
    ...
    for (var i = 0; i < formals.length; ++i) {
      ...
      switch (param.type) {
        case "Identifier":
          var value = argumentsList[iteratorRecord] || realm.intrinsics.undefined;
          ++iteratorRecord;
          var lhs = (0, _index2.ResolveBinding)(realm, param.name, strict);
          (0, _properties.PutValue)(realm, lhs, value);
          break;
        default:
          throw new _completions.ThrowCompletion(new _index.StringValue(realm, "only plain identifiers are supported in parameter lists"));
      }
    }
  } else {
    // 25. Else,
    ...
    (0, _invariant2.default)(formals !== undefined);
    for (var _i = 0; _i < formals.length; ++_i) {
      var _param = formals[_i];

      switch (_param.type) {
        case "Identifier":
          var _value = argumentsList[iteratorRecord] || realm.intrinsics.undefined;
          ++iteratorRecord;
          envRec.InitializeBinding(_param.name, _value);
          break;
        default:
          throw new _completions.ThrowCompletion(new _index.StringValue(realm, "only plain identifiers are supported in parameter lists"));
      }
  ...
  if (hasParameterExpressions === false) {
    ...
    varEnv = (0, _index2.NewDeclarativeEnvironment)(realm, env);
  ...
  if (strict === false) {
    ...
    lexEnv = (0, _index2.NewDeclarativeEnvironment)(realm, varEnv);
  ...
  try {
    for (var _iterator10 = lexDeclarations[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
      ...
      try {
        for (var _iterator12 = (0, _index3.BoundNames)(realm, _d)[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
  ...
  try {
    for (var _iterator11 = functionsToInitialize[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
      ...
      var _fn = (0, _index3.BoundNames)(realm, f)[0];
      ...
      varEnvRec.SetMutableBinding(_fn, fo, false);
    }
...
function SetFunctionName(realm, F, name, prefix) {
  ...
  (0, _invariant2.default)(typeof name === "string" || name instanceof _index.StringValue || name instanceof _index.SymbolValue, "expected name to be a string or symbol");
  ...
  if (name instanceof _index.SymbolValue) {
    ...
    if (description === undefined) {
      ...
      (0, _invariant2.default)(description !== null);
      name = new _index.StringValue(realm, "[" + description + "]");
    }
  }
  ...
  return (0, _index2.DefinePropertyOrThrow)(realm, F, "name", {
    value: name,
    enumerable: false,
    writable: false,
    configurable: true
...
function FunctionInitialize(realm, F, kind, ParameterList, Body, Scope) {
  ...
  (0, _index2.DefinePropertyOrThrow)(realm, F, "length", {
  ...
  F.$ScriptOrModule = (0, _index3.GetActiveScriptOrModule)(realm);
...
function AddRestrictedFunctionProperties(F, realm) {
  ...
  return (0, _index2.DefinePropertyOrThrow)(realm, F, "arguments", desc);
}
...
function InternalCall(realm, F, thisArgument, argsList, tracerIndex) {
  ...
  if (F.$FunctionKind === "classConstructor") throw new _completions.ThrowCompletion(new _index.StringValue(realm, "TypeError"));
...
function InternalConstruct(realm, F, argumentsList, newTarget, thisArgument, tracerIndex) {
  ...
  if (result instanceof _completions.ReturnCompletion) {
    ...
    if (!result.value.mightBeUndefined()) throw new _completions.ThrowCompletion(new _index.StringValue(realm, "TypeError"));
...
function FunctionAllocate(realm, functionPrototype, strict, functionKind) {
  ...
  var F = new _index.FunctionValue(realm);
...
function PerformEval(realm, x, evalRealm, strictCaller, direct) {
  ...
  if (direct) {
    ...
    lexEnv = (0, _index2.NewDeclarativeEnvironment)(realm, ctx.lexicalEnvironment);
    ...
    lexEnv = (0, _index2.NewDeclarativeEnvironment)(realm, evalRealm.$GlobalEnv);
      ...
      if (node.type !== "FunctionDeclaration") {
        ...
        if (!(res instanceof _index.EmptyValue)) {
          if (blockValue === undefined || blockValue instanceof _index.Value) {
            if (res instanceof _completions.AbruptCompletion) throw (0, _index3.UpdateEmpty)(realm, res, blockValue || realm.intrinsics.empty);
            ...
            if (res instanceof _completions.AbruptCompletion) {
              ...
              if (res instanceof _completions.IntrospectionThrowCompletion) {
                realm.apply_effects(e);
                throw res;
              }
              (0, _invariant2.default)(blockValue instanceof _completions.PossiblyNormalCompletion);
              e[0] = res;
              var joined_effects = (0, _index3.joinPossiblyNormalCompletionWithAbruptCompletion)(realm, blockValue, res, e);
              realm.apply_effects(joined_effects);
              throw joined_effects[0];
            } else {
              if (res instanceof _index.Value) blockValue.value = res;else {
                (0, _invariant2.default)(blockValue instanceof _completions.PossiblyNormalCompletion);
                (0, _invariant2.default)(res instanceof _completions.PossiblyNormalCompletion);
                blockValue = (0, _index3.joinPossiblyNormalCompletions)(realm, blockValue, res);
              }
            }
          }
        }
...
function FunctionCreate(realm, kind, ParameterList, Body, Scope, Strict, prototype) {
  ...
  if (!Strict && kind === "normal") {
    (0, _index2.DefinePropertyOrThrow)(realm, F, "arguments", {
...
function EvalDeclarationInstantiation(realm, body, varEnv, lexEnv, strict) {
  ...
  var varNames = [];
  (0, _traverse2.default)(body, function (node) {
    if (node.type === "VariableDeclaration" && node.kind === "var") {
      varNames = varNames.concat(Object.keys(t.getBindingIdentifiers(node)));
    }
  ...
  if (!strict) {
    ...
    if (varEnvRec instanceof _environment.GlobalEnvironmentRecord) {
      ...
      try {
        for (var _iterator20 = varNames[Symbol.iterator](), _step20; !(_iteratorNormalCompletion20 = (_step20 = _iterator20.next()).done); _iteratorNormalCompletion20 = true) {
          ...
          if (varEnvRec.HasLexicalDeclaration(name)) {
            throw new _completions.ThrowCompletion((0, _construct.Construct)(realm, realm.intrinsics.SyntaxError, [new _index.StringValue(realm, name + " global object is restricted")]));
          }
    ...
    while (thisLex !== varEnv) {
      ...
      if (!(thisEnvRec instanceof _environment.ObjectEnvironmentRecord)) {
        ...
        try {
          for (var _iterator21 = varNames[Symbol.iterator](), _step21; !(_iteratorNormalCompletion21 = (_step21 = _iterator21.next()).done); _iteratorNormalCompletion21 = true) {
            var _name2 = _step21.value;
  ...
  try {
    for (var _iterator22 = varDeclarations.reverse()[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
      var d = _step22.value;
  ...
  try {
    for (var _iterator23 = varDeclarations[Symbol.iterator](), _step23; !(_iteratorNormalCompletion23 = (_step23 = _iterator23.next()).done); _iteratorNormalCompletion23 = true) {
      var _d2 = _step23.value;
      ...
      if (_d2.type === "VariableDeclaration") {
        ...
        try {
          for (var _iterator28 = (0, _index3.BoundNames)(realm, _d2)[Symbol.iterator](), _step28; !(_iteratorNormalCompletion28 = (_step28 = _iterator28.next()).done); _iteratorNormalCompletion28 = true) {
            var vn = _step28.value;
  ...
  try {
    for (var _iterator24 = body.body[Symbol.iterator](), _step24; !(_iteratorNormalCompletion24 = (_step24 = _iterator24.next()).done); _iteratorNormalCompletion24 = true) {
      var s = _step24.value;
  ...
  try {
    for (var _iterator25 = lexDeclarations[Symbol.iterator](), _step25; !(_iteratorNormalCompletion25 = (_step25 = _iterator25.next()).done); _iteratorNormalCompletion25 = true) {
      var _d3 = _step25.value;
      ...
      try {
        for (var _iterator29 = (0, _index3.BoundNames)(realm, _d3)[Symbol.iterator](), _step29; !(_iteratorNormalCompletion29 = (_step29 = _iterator29.next()).done); _iteratorNormalCompletion29 = true) {
          var dn = _step29.value;
  ...
  try {
    for (var _iterator26 = functionsToInitialize[Symbol.iterator](), _step26; !(_iteratorNormalCompletion26 = (_step26 = _iterator26.next()).done); _iteratorNormalCompletion26 = true) {
      var f = _step26.value;

      // a. Let fn be the sole element of the BoundNames of f.
      var _fn2 = (0, _index3.BoundNames)(realm, f)[0];
      // b. Let fo be the result of performing InstantiateFunctionObject for f with argument lexEnv.
      var fo = lexEnv.evaluate(f, strict);
      (0, _invariant2.default)(fo instanceof _index.Value);
      ...
      if (varEnvRec instanceof _environment.GlobalEnvironmentRecord) {
        ...
        varEnvRec.CreateGlobalFunctionBinding(_fn2, fo, true);
      } else {
        // d. Else,
        // i. Let bindingExists be varEnvRec.HasBinding(fn).
        var bindingExists = varEnvRec.HasBinding(_fn2);
        // ii. If bindingExists is false, then
        if (!bindingExists) {
          // 1. Let status be ! varEnvRec.CreateMutableBinding(fn, true).
          varEnvRec.CreateMutableBinding(_fn2, true);
          ...
          varEnvRec.InitializeBinding(_fn2, fo);
        } else {
          // iii. Else,
          // 1. Perform ! varEnvRec.SetMutableBinding(fn, fo, false).
          varEnvRec.SetMutableBinding(_fn2, fo, false);
        }
      }
    }
  ...
  try {
    for (var _iterator27 = declaredVarNames[Symbol.iterator](), _step27; !(_iteratorNormalCompletion27 = (_step27 = _iterator27.next()).done); _iteratorNormalCompletion27 = true) {
      var _vn = _step27.value;

      // a. If varEnvRec is a global Environment Record, then
      if (varEnvRec instanceof _environment.GlobalEnvironmentRecord) {
        // i. Perform ? varEnvRec.CreateGlobalVarBinding(vn, true).
        varEnvRec.CreateGlobalVarBinding(_vn, true);
      } else {
        // b. Else,
        // i. Let bindingExists be varEnvRec.HasBinding(vn).
        var _bindingExists = varEnvRec.HasBinding(_vn);
        // ii. If bindingExists is false, then
        if (!_bindingExists) {
          // 1. Let status be ! varEnvRec.CreateMutableBinding(vn, true).
          varEnvRec.CreateMutableBinding(_vn, true);
          // 2. Assert: status is not an abrupt completion because of validation preceding step 12.
          // 3. Perform ! varEnvRec.InitializeBinding(vn, undefined).
          varEnvRec.InitializeBinding(_vn, realm.intrinsics.undefined);
        }
      }
    }
...
function MakeMethod(realm, F, homeObject) {
  ...
  // 1. Assert: F is an ECMAScript function object.
  (0, _invariant2.default)(F instanceof _index.FunctionValue, "F is an ECMAScript function object.");
