...
function thisBooleanValue(realm, value) {
  ...
  if (value instanceof _index.ObjectValue && value.$BooleanData) {
    ...
    (0, _invariant2.default)(value.$BooleanData instanceof _index.BooleanValue, "expected boolean data internal slot to be a boolean value");
...
function thisNumberValue(realm, value) {
  ...
  if (value instanceof _index.ObjectValue && value.$NumberData) {
    ...
    (0, _invariant2.default)(value.$NumberData instanceof _index.NumberValue, "expected number data internal slot to be a number value");
...
function thisStringValue(realm, value) {
  ...
  if (value instanceof _index.ObjectValue && value.$StringData) {
    ...
    (0, _invariant2.default)(value.$StringData instanceof _index.StringValue, "expected string data internal slot to be a string value");
...
function ToNumber(realm, val) {
  if (typeof val === "number") {
    ...
    throw _index.AbstractValue.createIntrospectionErrorThrowCompletion(val);
...
function IsToNumberPure(realm, val) {
  ...
  if (val instanceof _index.ObjectValue) return IsToPrimitivePure(realm, val);
  return true;
}
...
function GetToPrimitivePureResultType(realm, input) {
  ...
  if (input instanceof _index.PrimitiveValue || input instanceof _index.AbstractValue) return input.getType();
  (0, _invariant2.default)(input instanceof _index.ObjectValue);
  return undefined;
}
