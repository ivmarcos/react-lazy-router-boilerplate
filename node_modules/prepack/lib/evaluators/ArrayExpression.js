...
exports.default = function (ast, strictCode, env, realm) {
  ...
  for (var i = 0; i < len; i++) {
    ...
    if (elem.type === "SpreadElement") {
      ...
      while (true) {
        ...
        var status = (0, _index2.CreateDataProperty)(realm, array, new _index.StringValue(realm, nextIndex++ + ""), nextValue);
      ...
      var initValue = (0, _index2.GetValue)(realm, initResult);

      // 6. Let created be CreateDataProperty(array, ToString(ToUint32(postIndex+padding)), initValue).
      var created = (0, _index2.CreateDataProperty)(realm, array, new _index.StringValue(realm, nextIndex++ + ""), initValue);
  ...
  (0, _index2.Set)(realm, array, "length", new _index.NumberValue(realm, nextIndex), false);
