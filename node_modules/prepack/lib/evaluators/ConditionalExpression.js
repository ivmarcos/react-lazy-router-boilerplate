...
exports.default = function (ast, strictCode, env, realm) {
  ...
  if (!exprValue.mightNotBeObject()) return env.evaluate(ast.consequent, strictCode);else return (0, _IfStatement.evaluateWithAbstractConditional)(exprValue, ast.consequent, ast.alternate, strictCode, env, realm);
};
