...
var ProxyValue = function (_ObjectValue) {
  ...
  _createClass(ProxyValue, [{
    ...
    value: function $GetPrototypeOf() {
      ...
      if (handler instanceof _index2.NullValue) {
        throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
      }

      // 3. Assert: Type(handler) is Object.
      (0, _invariant2.default)(handler instanceof _index2.ObjectValue, "expected an object");

      // 4. Let target be the value of the [[ProxyTarget]] internal slot of O.
      var target = this.$ProxyTarget;
      (0, _invariant2.default)(target instanceof _index2.ObjectValue);

      // 5. Let trap be ? GetMethod(handler, "getPrototypeOf").
      var trap = (0, _get.GetMethod)(realm, handler, "getPrototypeOf");

      // 6. If trap is undefined, then
      if (trap instanceof _index2.UndefinedValue) {
      ...
      if (!(handlerProto instanceof _index2.ObjectValue) && !(handlerProto instanceof _index2.NullValue)) {
        throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
      }
    ...
    value: function $SetPrototypeOf(V) {
      ...
      (0, _invariant2.default)(V instanceof _index2.ObjectValue || V instanceof _index2.NullValue, "expected object or null");
      ...
      (0, _invariant2.default)(handler instanceof _index2.ObjectValue, "expected object");
    ...
    value: function $GetOwnProperty(P) {
      ...
      var trapResultObj = (0, _call.Call)(realm, trap, handler, [target, typeof P === "string" ? new _index2.StringValue(realm, P) : P]);

      // 9. If Type(trapResultObj) is neither Object nor Undefined, throw a TypeError exception.
      if (!(trapResultObj instanceof _index2.ObjectValue) && !(trapResultObj instanceof _index2.UndefinedValue)) {
        throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
      }
      ...
      if (trapResultObj instanceof _index2.UndefinedValue) {
    ...
    value: function $DefineOwnProperty(P, Desc) {
      ...
      var booleanTrapResult = (0, _to.ToBooleanPartial)(realm, (0, _call.Call)(realm, trap, handler, [target, typeof P === "string" ? new _index2.StringValue(realm, P) : P, descObj]));
    ...
    value: function $HasProperty(P) {
      ...
      var booleanTrapResult = (0, _to.ToBooleanPartial)(realm, (0, _call.Call)(realm, trap, handler, [target, typeof P === "string" ? new _index2.StringValue(realm, P) : P]));
    ...
    value: function $Get(P, Receiver) {
      ...
      var trapResult = (0, _call.Call)(realm, trap, handler, [target, typeof P === "string" ? new _index2.StringValue(realm, P) : P, Receiver]);
      ...
      if (targetDesc) {
        ...
        if ((0, _is.IsAccessorDescriptor)(realm, targetDesc) && targetDesc.configurable === false && (!targetDesc.get || targetDesc.get instanceof _index2.UndefinedValue)) {
          // i. If trapResult is not undefined, throw a TypeError exception.
          if (!(trapResult instanceof _index2.UndefinedValue)) {
            throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
          }
        }
      }
    ...
    value: function $Set(P, V, Receiver) {
      ...
      var booleanTrapResult = (0, _to.ToBooleanPartial)(realm, (0, _call.Call)(realm, trap, handler, [target, typeof P === "string" ? new _index2.StringValue(realm, P) : P, V, Receiver]));
      ...
      if (targetDesc) {
        ...
        if ((0, _is.IsAccessorDescriptor)(realm, targetDesc) && !targetDesc.configurable) {
          ...
          if (!targetDesc.set || targetDesc.set instanceof _index2.UndefinedValue) {
            throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError);
          }
        }
      }
    ...
    value: function $OwnPropertyKeys() {
      ...
      try {
        for (var _iterator = targetKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          (0, _invariant2.default)(key instanceof _index2.SymbolValue || key instanceof _index2.StringValue, "expected string or symbol");
        }
      ...
      try {
        for (var _iterator4 = targetConfigurableKeys[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          ...
          // a. If key is not an element of uncheckedResultKeys, throw a TypeError exception.
          var _index = FindPropertyKey(realm, uncheckedResultKeys, _key3);
          if (_index < 0) {
            throw realm.createErrorThrowCompletion(realm.intrinsics.TypeError, "key is not an element of uncheckedResultKeys");
          }

          // b. Remove key from uncheckedResultKeys.
          uncheckedResultKeys.splice(_index, 1);
        }
